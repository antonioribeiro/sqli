...
[![Latest Stable Version](https://poser.pugx.org/pragmarx/select/v/stable.png)](https://packagist.org/packages/pragmarx/select) [![License](https://poser.pugx.org/pragmarx/select/license.png)](https://packagist.org/packages/pragmarx/select) [![Build Status](https://travis-ci.org/antonioribeiro/select.png)](https://travis-ci.org/antonioribeiro/select) [![Latest Stable Version](https://coveralls.io/repos/antonioribeiro/select/badge.png)](https://coveralls.io/r/antonioribeiro/select)
...
Select comes with some examples:
...
Select comes with some examples, but you can get crazy and create as many as you wish:
...
But after Select, you just need to do this in your code:
...
Select has two artisan commands:

`select:templates` - to copy the examples to your `app/config/package` folder

    php artisan select:templates

`select:list` - list all of your Select commands

    php artisan select:list
...
To compile a view using Select, you just have to:

     return Select::inject('@input(type=email,name=email,class=form-control)')
...
Require the Select package:
    ...
    composer require pragmarx/select dev-master
...
To publish the configuration file you'll have to:
    ...
    php artisan config:publish pragmarx/select
...
- Select Tests Coverage is at 100%

### TODO

- Invalidate main templates when a Select command changes
